...
public class Login extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputEmail = (EditText) findViewById(com.project.yousof.androidapp.R.id.email);
        inputPassword = (EditText) findViewById(com.project.yousof.androidapp.R.id.pword);
        Btnregister = (Button) findViewById(com.project.yousof.androidapp.R.id.registerbtn);
        btnLogin = (Button) findViewById(com.project.yousof.androidapp.R.id.login);
        passreset = (Button) findViewById(R.id.passres);
        loginErrorMsg = (TextView) findViewById(com.project.yousof.androidapp.R.id.loginErrorMsg);
        ...
        protected Boolean doInBackground(String... args){
            ...
            if (netInfo != null && netInfo.isConnected()) {
                try {
                    ...
                    //url = new URL("http://10.0.2.2"); //checks for working internet connection by trying Google.
