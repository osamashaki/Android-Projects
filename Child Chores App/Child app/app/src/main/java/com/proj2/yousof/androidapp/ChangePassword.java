...
public class ChangePassword extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.proj2.yousof.androidapp.R.layout.changepassword);

        cancel = (Button) findViewById(com.proj2.yousof.androidapp.R.id.btcancel);
        cancel.setOnClickListener(new View.OnClickListener(){
        public void onClick(View arg0){

                Intent login = new Intent(getApplicationContext(), Main.class);
                login.putExtra("sid",sid);
                startActivity(login);
                finish();
            }
        ...
        newpass = (EditText) findViewById(com.proj2.yousof.androidapp.R.id.newpass);
        alert = (TextView) findViewById(com.proj2.yousof.androidapp.R.id.alertpass);
        changepass = (Button) findViewById(com.proj2.yousof.androidapp.R.id.btchangepass);

        sid = getIntent().getStringExtra("sid");
        //Toast.makeText(getApplicationContext(), "stuid: " + sid, Toast.LENGTH_LONG).show();
