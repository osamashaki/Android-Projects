...
public class Ques7 extends Activity implements View.OnClickListener {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if(!a.isChecked() && !b.isChecked() && !c.isChecked())
                {
                    ...
                    Intent myIntent = new Intent(view.getContext(), Ques8.class);
