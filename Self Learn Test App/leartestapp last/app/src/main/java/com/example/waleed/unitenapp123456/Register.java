 ...
 **/
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    if ( inputUsername.getText().toString().length() > 4 && inputUsername.getText().toString().length() < 13 )
                    {
                    ...
                    else
                    {
                        Toast.makeText(getApplicationContext(),
                                "Username should be between 5 and 12 characters", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
                    Toast.makeText(getApplicationContext(),
                            "One or more fields are incorrect", Toast.LENGTH_SHORT).show();
                }
            }
        });
       }
