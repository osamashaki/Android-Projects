...
public class ChangePassword extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.waleed.unitenapp123456.R.layout.changepassword);

        cancel = (Button) findViewById(com.example.waleed.unitenapp123456.R.id.btcancel);
        ...
        newpass = (EditText) findViewById(com.example.waleed.unitenapp123456.R.id.newpass);
        alert = (TextView) findViewById(com.example.waleed.unitenapp123456.R.id.alertpass);
        changepass = (Button) findViewById(com.example.waleed.unitenapp123456.R.id.btchangepass);
